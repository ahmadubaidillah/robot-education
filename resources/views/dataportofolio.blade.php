    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/dataproduct" class="nav-link ">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Tables Products
              </p>
          ...
          <li class="nav-item">
            <a href="/dataportofolio" class="nav-link active">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Tables Portofolio
              </p>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Portofolio Tables</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Portofolio Tables</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
    <div class="container">
    <a href="/tambahportofolio" class="btn btn-success ">+ Tambah Data</a>
    <form method="GET" action="/dataportofolio" class="d-flex mb-3 justify-content-end">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$row->judul}}</td>
              <td>{{$row->nama}}</td>
              <td> <img src="{{asset('fotoportofolio/'.$row->foto)}}" alt="" style="width:50px;"></td>
              <td>{{$row->deskripsi}}</td>
              <td>{{$row->quote}}</td>
              <td>{{$row->penulis}}</td>
              <td>
                <a href="/deleteportofolio/{{$row->id}}" class="btn btn-danger">Delete</a>
                <a href="/tampilportofolio/{{$row->id}}" class="btn btn-warning text-white">Edit</a>
              </td>
            </tr>
            @endforeach
          </tbody>
