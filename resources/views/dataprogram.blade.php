    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/dataprogram" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Program Tables</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Program Tables</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
    <div class="container">
    <a href="/tambahprogram" class="btn btn-success ">+ Tambah Data</a>
    <form method="GET" action="/dataprogram" class="d-flex mb-3 justify-content-end">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$row->nama}}</td>
              <td> <img src="{{asset('fotoprogram/'.$row->foto)}}" alt="" style="width:50px;"></td>
              <td>{{$row->deskripsi}}</td>
              <td>{{$row->harga}}</td>
              <td>
                <a href="/deleteprogram/{{$row->id}}" class="btn btn-danger">Delete</a>
                <a href="/tampilprogram/{{$row->id}}" class="btn btn-warning text-white">Edit</a>
              </td>
            </tr>
            @endforeach
          </tbody>
