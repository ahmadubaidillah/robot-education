    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/datacontact" class="nav-link active">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Tables Contacts
              </p>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Contact Tables</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <!-- Main content -->
    <div class="container">
    <form method="GET" action="/datacontact" class="d-flex mb-5 justify-content-end">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$row->message}}</td>
              <td>
                <a href="/deletecontact/{{$row->id}}" class="btn btn-danger">Delete</a>
              </td>
            </tr>
            @endforeach
          </tbody>
