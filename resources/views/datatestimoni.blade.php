    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/datatestimoni" class="nav-link active">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Tables Testimonials
              </p>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Testimonials Tables</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <!-- Main content -->
    <div class="container">
    <a href="/tambahtestimoni" class="btn btn-success ">+ Tambah Data</a>
    <form method="GET" action="/datatestimoni" class="d-flex mb-3 justify-content-end">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$row->nama}}</td>
              <td> <img src="{{asset('fototestimoni/'.$row->foto)}}" alt="" style="width:50px;"></td>
              <td>{{$row->testimoni}}</td>
              <td>
                <a href="/deletetestimoni/{{$row->id}}" class="btn btn-danger">Delete</a>
                <a href="/tampiltestimoni/{{$row->id}}" class="btn btn-warning text-white">Edit</a>
              </td>
            </tr>
            @endforeach
          </tbody>
