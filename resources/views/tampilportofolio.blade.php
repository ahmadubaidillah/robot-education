...
<html lang="en">
  ...
  <body>
    <h1 class="text-center mb-4">Edit Data Portofolio</h1>
    <div class="container">
      <div class="row justify-content-center">
       <div class="col-8">
       <div class="card">
          <div class="card-body">
            <form action="/updateportofolio/{{$data->id}}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Deskripsi Portofolio</label>
              ...
              <div class="mb-3">
                ...
                <input type="text" name="quote" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->quote}}">
              </div>
              <div class="mb-3">
